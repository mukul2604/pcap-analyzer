...
public class analysis_pcap_tcp {
    ...
    public static HashMap<Integer, TcpFlowPartB> tcpFlowHashMap = new HashMap<>();

    public static void packetFlowInfoDump() {
        for (Integer key: tcpFlowHashMap.keySet()) {
            System.out.println("===================================================================================");
            TcpFlowPartB flow = tcpFlowHashMap.get(key);
            flow.dumpInfo();
        }
    }
    ...
    public static void main(String[] args) {
        ...
        while (pcap.nextEx(hdr, buf) == Pcap.NEXT_EX_OK) {
            ...
            if (packet.hasHeader(tcp)) {
                ...
                TcpPacketParserPartB tcpPacketParser = new TcpPacketParserPartB(frameBuffer.array(), tsmsecs);
