...
import static PartB.analysis_pcap_tcp.*;
...
public class TcpPacketParserPartB {
...
//    private int timeStamp;
    ...
    public TcpPacketParserPartB(byte [] frame, long timeStamp){
...
//        this.timeStamp = extractTimeStamp(subArr);
        ...
        TcpFlowPacketPartB fPacket = new TcpFlowPacketPartB(sourcePort,destinationPort, seqNo,
        ...
        if ((flags & SYN) == SYN && (flags & ACK) != ACK) {
            ...
            TcpFlowPartB flow = new TcpFlowPartB(sourcePort, destinationPort);
