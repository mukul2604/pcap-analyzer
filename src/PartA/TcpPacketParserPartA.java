...
public class TcpPacketParserPartA {
...
//    private int timeStamp;
    ...
    public TcpPacketParserPartA(byte [] frame, long timeStamp){
...
//        this.timeStamp = extractTimeStamp(subArr);
        ...
        TcpFlowPacketPartA fPacket = new TcpFlowPacketPartA(sourcePort,destinationPort, seqNo,
        ...
        if ((flags & SYN) == SYN && (flags & ACK) != ACK) {
            ...
            TcpFlowPartA flow = new TcpFlowPartA(sourcePort, destinationPort);
