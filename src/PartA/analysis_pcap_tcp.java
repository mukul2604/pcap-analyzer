...
public class analysis_pcap_tcp {
    ...
    public static HashMap<Integer, TcpFlowPartA> tcpFlowHashMap = new HashMap<>();

    public static void packetFlowInfoDump() {
        for (Integer key: tcpFlowHashMap.keySet()) {
            System.out.println("===================================================================================");
            TcpFlowPartA flow = tcpFlowHashMap.get(key);
            flow.dumpInfo();
        }
    }
    ...
    public static void main(String[] args) {
        final String FILE_NAME = "/home/cloudera/workspace/fcn_hw2/src/PartA/assignment2.pcap";
        ...
        while (pcap.nextEx(hdr, buf) == Pcap.NEXT_EX_OK) {
            ...
            if (packet.hasHeader(tcp)) {
                ...
                TcpPacketParserPartA tcpPacketParser = new TcpPacketParserPartA(frameBuffer.array(), tsmsecs);
